...
namespace BILWeb.Quality
{
    public partial class T_QualityDetail_DB : BILBasic.Basing.Factory.Base_DB<T_QualityDetailInfo>
    {
        ...
        protected override List<string> GetDeleteSql(UserModel user, T_QualityDetailInfo model)
        {
            List<string> strlist = new List<string>();
            strlist.Add("delete from T_QUALITY where ERPVOUCHERNO='" + model.ErpVoucherNo + "'");
            strlist.Add("delete from T_QUALITYDETAIL where ERPVOUCHERNO = '" + model.ErpVoucherNo + "'");
            return strlist;
        }
        ...
        protected override string GetFilterSql(UserModel user, T_QualityDetailInfo model)
        {
            ...
            {
                strSql += strAnd;
                strSql += " InErpVoucherNo like  '%" + model.ErpInVoucherNo.Trim() + "%'  ";
            }

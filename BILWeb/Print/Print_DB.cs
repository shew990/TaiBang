...
namespace BILWeb.Print
{
    public partial class Print_DB
    {
        ...
        public bool SubBarcodesNoPrint(List<Barcode_Model> list, ref string ErrMsg)
        {
            ...
            sqls.Add("update  t_outbarcode  set t_outbarcode.materialnoid=T_MATERIAL.id from t_outbarcode,T_MATERIAL where t_outbarcode.materialno = T_MATERIAL.materialno and t_outbarcode.strongholdcode = T_MATERIAL.strongholdcode  and t_outbarcode.materialnoid is null");
            dbFactory.ExecuteNonQueryList(sqls);

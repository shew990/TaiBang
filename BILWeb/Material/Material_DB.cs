...
namespace BILWeb.Material
{
    public partial class T_Material_DB : BILBasic.Basing.Factory.Base_DB<T_MaterialInfo>
    {
        ...
        protected override T_MaterialInfo ToModel(IDataReader reader)
        {
            ...
            //t_material.dEDate = (DateTime)dbFactory.ToModelValue(reader, "dEDate");
            t_material.strdEDate = dbFactory.ToModelValue(reader, "dEDate")==null?"": (((DateTime)dbFactory.ToModelValue(reader, "dEDate")).ToString("yyyy/MM/dd HH:mm:ss"));

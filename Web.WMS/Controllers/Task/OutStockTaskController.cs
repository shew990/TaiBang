...
namespace Web.WMS.Controllers.Task
{
    ...
    public class OutStockTaskController : BaseController<T_OutStockTaskInfo>
    {
        ...
        public FileResult Excel(T_OutStockTaskInfo model)
        {
            ...
            List <T_OutStockTaskInfo> lstExport = new List<T_OutStockTaskInfo>();
            ...
            row1.CreateCell(4).SetCellValue("供应商");
            ...
            for (int i = 0; i < lstExport.Count; i++)
            {
                ...
                rowtemp.CreateCell(4).SetCellValue(lstExport[i].SupcusName);
                rowtemp.CreateCell(5).SetCellValue(lstExport[i].StrStatus);
                rowtemp.CreateCell(6).SetCellValue(lstExport[i].CreateTime.ToString());
                rowtemp.CreateCell(7).SetCellValue(lstExport[i].WareHouseName);
            }
            // 写入到客户端 
